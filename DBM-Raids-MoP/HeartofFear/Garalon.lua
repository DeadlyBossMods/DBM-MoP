...
local specwarnLeg				= mod:NewSpecialWarningSwitch(-6270, "Melee")--If no legs are up (ie all dead), when one respawns, this special warning can be used to alert of a respawned leg and to switch back.

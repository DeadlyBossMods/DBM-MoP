local mod	= DBM:NewMod(851, "DBM-Raids-MoP", 1, 369)
...
local timerFearsomeRoarCD			= mod:NewCDTimer(11, 143766, nil, "Tank", nil, 5, nil, DBM_COMMON_L.TANK_ICON)
local timerDeafeningScreechCD		= mod:NewNextCountTimer(13, 143343, nil, nil, nil, 2, nil, DBM_COMMON_L.HEALER_ICON)-- (143345 base power regen, 4 every half second)
--Stage 2: Frenzy for Blood!
local timerBloodFrenzyCD			= mod:NewNextTimer(5, 143442)
local timerBloodFrenzyEnd			= mod:NewBuffActiveTimer(13.5, 143442)
local timerFixate					= mod:NewTargetTimer(12, 143445, nil, nil, nil, 3, nil, DBM_COMMON_L.DEADLY_ICON)
local timerKey						= mod:NewTargetTimer(60, 146589, nil, false)
--Infusion of Acid
local timerAcidBreath				= mod:NewTargetTimer(30, 143780, nil, "Tank|Healer")
local timerAcidBreathCD				= mod:NewCDTimer(11, 143780, nil, "Tank", nil, 5, nil, DBM_COMMON_L.TANK_ICON)--Often 12, but sometimes 11
...
local timerFrostBreathCD			= mod:NewCDTimer(9.5, 143773, nil, "Tank", nil, 5, nil, DBM_COMMON_L.TANK_ICON)
--Infusion of Fire
local timerScorchingBreath			= mod:NewTargetTimer(30, 143767, nil, "Tank|Healer")
local timerScorchingBreathCD		= mod:NewCDTimer(11, 143767, nil, "Tank", nil, 5, nil, DBM_COMMON_L.TANK_ICON)--Often 12, but sometimes 11

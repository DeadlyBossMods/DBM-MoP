...
local specWarnFocusedLightning		= mod:NewSpecialWarningRun(137422, nil, nil, 2, 4, 2)
local yellFocusedLightning			= mod:NewYell(137422)
local specWarnStaticBurst			= mod:NewSpecialWarningYou(137162, nil, nil, nil, 1, 17)
local specWarnStaticBurstOther		= mod:NewSpecialWarningTaunt(137162, nil, nil, nil, 1, 2)
local specWarnThrow					= mod:NewSpecialWarningYou(137175, nil, nil, nil, 1, 12)
local specWarnThrowOther			= mod:NewSpecialWarningTaunt(137175, nil, nil, nil, 1, 2)
...
local specWarnStorm					= mod:NewSpecialWarningSpell(137313, nil, nil, nil, 2, 2)
local specWarnElectrifiedWaters		= mod:NewSpecialWarningGTFO(138006, nil, nil, nil, 1, 8)
local specWarnIonization			= mod:NewSpecialWarningSpell(138732, nil, nil, nil, 2, 2)

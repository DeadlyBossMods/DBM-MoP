...
local specWarnSeriousWound			= mod:NewSpecialWarningStack(133767, nil, 5, nil, nil, 1, 6, nil, nil, "stackhigh")--This we will use debuff on though.
local specWarnSeriousWoundOther		= mod:NewSpecialWarningTaunt(133767, nil, nil, nil, 1, 2, nil, nil, "tauntboss")
local specWarnForceOfWill			= mod:NewSpecialWarningDodge(136413, nil, nil, nil, 3, 2, nil, nil, "stilldanger")
local yellForceOfWill				= mod:NewYell(136413)
local specWarnLingeringGaze			= mod:NewSpecialWarningMoveAway(138467, nil, nil, nil, 1, 2, nil, nil, "runout")
local yellLingeringGaze				= mod:NewYell(138467, nil, false)
local specWarningGTFO				= mod:NewSpecialWarningGTFO(138467, nil, nil, nil, 1, 8, nil, nil, "watchfeet")
local specWarnBlueBeam				= mod:NewSpecialWarning("specWarnBlueBeam", nil, nil, nil, 3, 17, nil, nil, nil, nil, "blueyou")
local specWarnBlueBeamLFR			= mod:NewSpecialWarningYou(139202, true, false, nil, 3, 17, nil, nil, "blueyou")
local specWarnRedBeam				= mod:NewSpecialWarningYou(139204, nil, nil, nil, 3, 17, nil, nil, "redyou")
local specWarnYellowBeam			= mod:NewSpecialWarningYou(133738, nil, nil, nil, 3, 17, nil, nil, "yellowyou")
local specWarnFogRevealed			= mod:NewSpecialWarning("specWarnFogRevealed", nil, nil, nil, 1, 2, nil, nil, nil, nil, "killbigmob")--Use another "Be Aware!" sound because Lingering Gaze comes on Spectrum phase.
local specWarnDisintegrationBeam	= mod:NewSpecialWarningSpell(-6882, nil, nil, nil, 2, 2, nil, nil, "specialsoon")
local specWarnLifeDrain				= mod:NewSpecialWarningTarget(133795, "Tank", nil, nil, 1, 2, nil, nil, "helpsoak")

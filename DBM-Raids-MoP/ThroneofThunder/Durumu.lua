...
local specWarnBlueBeam				= mod:NewSpecialWarning("specWarnBlueBeam", nil, nil, nil, 3, 18)
local specWarnBlueBeamLFR			= mod:NewSpecialWarningYou(139202, true, false, nil, 3, 18)
local specWarnRedBeam				= mod:NewSpecialWarningYou(139204, nil, nil, nil, 3, 18)
local specWarnYellowBeam			= mod:NewSpecialWarningYou(133738, nil, nil, nil, 3, 18)

...
local specWarnDiffusionChainSoon		= mod:NewSpecialWarningPreWarn(135991, nil, 4, nil, nil, 1, 2, nil, nil, "scatter")
local specWarnOvercharged				= mod:NewSpecialWarningYou(136295)
local yellOvercharged					= mod:NewShortYell(136295)
local specWarnBouncingBoltSoon			= mod:NewSpecialWarningPreWarn(136361, nil, 4, nil, nil, 1, 2, nil, nil, "specialsoon")
